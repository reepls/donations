      ...
      <div className="max-w-md md:max-w-lg lg:max-w-2xl mx-auto">
        ...
        <div className="mb-4">
          ...
          >
            ...
            <span className="text-sm md:text-base">Back to Donations</span>
          </button>
        </div>
        {/* Header Section */}
        <div className="text-center mb-6">
          ...
          <p className="text-neutral-200 text-sm md:text-base leading-relaxed">
            Set up a recurring monthly donation to continuously support Reepls. 
            Your consistent contribution helps us maintain the platform and empower writers to share their voices with the world.
          </p>
        </div>
